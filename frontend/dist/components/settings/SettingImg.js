...
export const SettingImg = defineComponent({
  ...
  render() {
    return h("div", {
      className: "position-relative  c-settings-image "
    }, h("img", {
      src: this.state.imgUrl,
      className: " w-100 h-100  rounded-circle"
    }), h("button", {
      className: "position-absolute position-absolute bottom-0 end-0  rounded-circle d-flex justify-content-center align-items-center  c-edit-icon border-0",
      "on:click": () => {
      ...
      class: "fa-regular fa-pen-to-square m-0 fs-5"
    })));
  },
  methods: {
