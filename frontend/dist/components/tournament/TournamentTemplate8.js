...
export const TournamentTemplate8 = defineComponent({
  render() {
    const firstRoundSection1 = [{
      id: 1,
      avatar: "https://i.pinimg.com/736x/a0/83/0d/a0830dfdf3e69327638408ed5d61d077.jpg",
      display_name: "Blaze",
      isEliminated: true,
      score: 2 // Lost in the first round
    }, {
      id: 2,
      avatar: "https://i.pinimg.com/564x/85/29/a7/8529a7f675f1e4fa9f72c8a3f5452d7c.jpg",
      display_name: "Frost",
      isEliminated: false,
      score: 8 // Won in the first round
    }, {
      id: 3,
      avatar: "https://i.pinimg.com/564x/d3/df/6f/d3df6fdc4313dd9b55a51da2487c7232.jpg",
      display_name: "Storm",
      isEliminated: true,
      score: 4 // Lost in the first round
    }, {
      id: 4,
      avatar: "https://i.pinimg.com/564x/b7/1c/3b/b71c3b6f7ff10b67f3e4ed11d43fb489.jpg",
      display_name: "Shadow",
      isEliminated: false,
    ...
    const firstRoundSection2 = [{
      id: 5,
      avatar: "https://i.pinimg.com/564x/39/dd/9f/39dd9f4a9629f0c04a4a2fa1b97fb269.jpg",
      display_name: "Nova",
      isEliminated: false,
      score: 9 // Won in the first round
    }, {
      id: 6,
      avatar: "https://i.pinimg.com/736x/f3/58/ec/f358ecb4bccb7a8730f8638b4ec29992.jpg",
      display_name: "Zephyr",
      isEliminated: true,
      score: 3 // Lost in the first round
    }, {
      id: 7,
      avatar: "https://i.pinimg.com/564x/f2/53/51/f253510017ce97f6c8a56f20288d0073.jpg",
      display_name: "Echo",
      isEliminated: false,
      score: 8 // Won in the first round
    }, {
      id: 8,
      avatar: "https://i.pinimg.com/736x/f7/0d/da/f70ddade03d15f7419c7de8e6e0fa5ca.jpg",
      display_name: "Vortex",
      isEliminated: true,
    ...
    return h("div", {
    ...
    }, firstRoundSection1.map(player => h("div", null, h(TournamentPlayerCard, {
      userData: player
    })))), h("div", {
      className: "d-flex flex-row flex-lg-column justify-content-center  h-100 flex-grow-1 c-linker"
    }, h("div", {
      className: "d-flex flex-row flex-lg-column justify-content-center  h-50 flex-grow-1"
    }, h("div", {
      ...
      className: " d-flex flex-row flex-lg-column justify-content-around  "
    }, secondRoundSection1.map(player => h("div", null, h(TournamentPlayerCard, {
      userData: player
    })))), h("div", {
      className: "d-flex flex-row flex-lg-column justify-content-center  h-100 flex-grow-1 c-linker"
    }, h("div", {
    ...
    }, secondRoundSection2.map(player => h("div", null, h(TournamentPlayerCard, {
      userData: player
    })))), h("div", {
      className: "h-100 d-flex flex-row flex-lg-column justify-content-center  flex-grow-1 c-linker"
    }, h("div", {
      className: "d-flex flex-row flex-lg-column justify-content-center  h-50 flex-grow-1"
    }, h("div", {
      className: " d-none d-lg-block h-50 c-2-linker border-end-0"
      ...
      className: " d-flex flex-row flex-lg-column justify-content-around  "
    }, firstRoundSection2.map(player => h("div", null, h(TournamentPlayerCard, {
      userData: player
    }))))));
  }
});